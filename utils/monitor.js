...
class Monitor {
    ...
    log(startTime, endTime, name, uuid, sizeSame) {
        ...
        console.log('size same ', sizeSame);
        ...
        console.log('=============================')
        this._csvWriter.append(`${sizeSame}, ${this._csvInfo.eachSize}, ${this._csvInfo.totalSize}, ${runTime}, ${totalIter}, ${minCPU}, ${maxCPU}, ${avgCPU}, ${minMEM}, ${maxMEM}, ${avgMEM}`);
